# [Atm7 Sky 1.2.3](https://www.curseforge.com/minecraft/modpacks/all-the-mods-7-to-the-sky) on Curseforge
...
The docker on first run will download the same version as tagged of Atm7 Sky 1.2.3 and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "Atm7 Sky 1.2.3 Server Powered by Docker"
* LEVEL 
...
## Source
Github: https://github.com/Goobaroo/docker-atm7sky

Docker: https://hub.docker.com/repository/docker/goobaroo/atm7sky